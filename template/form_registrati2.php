<form style="width: 22rem;" action="processa-inserimento.php" method="POST">
    ...
    <button type="button" class="btn px-0" data-bs-toggle="popover" title="Non preoccuparti!" data-bs-content="Solo tu potrai vedere i tuoi preferiti." data-bs-html="true"><em class="bi bi-info-circle"></em></button>
