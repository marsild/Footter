<form>
    ...
    <div class="form-outline mb-4">
        <input type="password" id="form2Example3" class="form-control" placeholder="Email">
        <label class="form-label" for="form2Example3" style="margin-left: 0px;" hidden>Email</label>
    ...
    <div class="d-grid col-5">
        <a href="registrati2.php" role="button" class="btn btn-primary btn-block w-20">Continua</a>
    </div>
</form>