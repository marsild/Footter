                ...
                <aside class="mt-5">
                    <ul class="nav">
                        <li class="nav-item w-100">
                            <a class="nav-link<?php if ($templateParams["active"] == "Profilo") {
                                                    echo ' active" aria-current="page';
                                                } ?>" href="profilo.php">Profilo <span class="bi bi-person-circle"></span></a>
                        </li>
                        <li class="nav-item w-100">
                            <a class="nav-link<?php if ($templateParams["active"] == "Home") {
                                                    echo ' active" aria-current="page';
                                                } ?>" href="index.php">Home <span class="bi bi-house"></span></a>
                        </li>
                        <li class="nav-item w-100">
                            <a class="nav-link<?php if ($templateParams["active"] == "Cerca") {
                                                    echo ' active" aria-current="page';
                                                } ?>" href="cerca.php">Cerca <span class="bi bi-search"></span></a>
                        </li>
                        <li class="nav-item w-100">
                            <a class="nav-link<?php if ($templateParams["active"] == "Notifiche") {
                                                    echo ' active" aria-current="page';
                                                    ...
                                                    echo ' text-warning"';
                                                } ?>" href="notifiche.php">Notifiche <span class="bi bi-bell<?php if ($templateParams["active"] != "Notifiche" && $dbh->getNotificheNonVisualizzate($_SESSION["username"])[0]["nr"] > 0) {
                                                                                                                                                                                                                                                                                                        echo "-fill text-warning";
                                                                                                                                                                                                                                                                                                    } ?>"></span></a>
                        </li>
                        <li class="nav-item w-100">
                            <a class="nav-link<?php if ($templateParams["active"] == "Crea") {
                                                    echo ' active" aria-current="page';
                                                } ?>" href="crea.php">Crea <span class="bi bi-pencil-square"></span></a>
                        </li>
                        <li class="nav-item w-100">
                            <a class="nav-link<?php if ($templateParams["active"] == "Preferiti") {
                                                    echo ' active" aria-current="page';
                                                } ?>" href="preferiti.php">Preferiti <span class="bi bi-star"></span></a>
                        </li>
                        <li class="nav-item w-100">
                            <a class="nav-link<?php if ($templateParams["active"] == "Impostazioni") {
                                                    echo ' active" aria-current="page';
                                                } ?>" href="impostazioni.php">Impostazioni <span class="bi bi-gear"></span></a>
                        </li>
                        <li class="nav-item w-100">
                            <a class="nav-link" href="logout.php">Esci <span class="bi bi-box-arrow-left"></span></a>
                        </li>
                    </ul>
                </aside>
            </div>
